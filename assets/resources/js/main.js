    ...
    class Search {
        ...
        initCatalogs() {
            switch (this.pageContainerClass) {
                case '.search-result-container':
                    ...
                    let catalogsHeader = createElement('div', 'products-section-head', 'Каталоги', this.catalogsContainer);
                    break;
            ...
            let catalogsCardsContainer = createElement('div', 'search-catalogs-list container showFirst', '', this.catalogsContainer);
        ...
        initProducts() {
            ...
            for (let product of this.data.products.content) {
                ...
                let itemProductContainer = createElement('div', 'products-section-card', null, productsCardsContainer);
                let imgWrapCatalog = createElement('div', 'products-section-img', null, itemProductContainer);
                let nameCatalog = createElement('div', 'products-section-text', product.title, itemProductContainer);
                let priceCatalog = createElement('div', 'products-section-price', price, itemProductContainer);
                let btnContainerCatalog = createElement('div', 'products-section-btn', null, itemProductContainer);
                let btnCatalog = createElement('a', 'btn', 'Подробнее', btnContainerCatalog);
